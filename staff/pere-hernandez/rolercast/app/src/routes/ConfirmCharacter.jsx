...
function ConfirmCharacter ({ onRetrunClick, onCharacterCreated }) {
    ...
    const handleSubmit = event => {
        ...
        try{
            logic.createCharacter(name, race._id, characterClass._id, background.id, hp, stats, proficiencies, expertises, cantrips, spells, actions, instrument, deityId, fightingStyleId, archetypeId, naturalExplorerId)
                .then(() => {
                    form.reset()
